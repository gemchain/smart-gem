...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "The Star 28/Feb/2018 Indonesia seizes luxury yacht linked to 1MDB investigation";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1519769520;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 875236;
        ...
        assert(hashGenesisBlock == uint256("0x000009629341fabf606d09beccf81cfb87ddf4f15fd83f6737e1acbcf93ce4f0"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("smartgem.test", "test.smartgem.org"));
